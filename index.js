...
app.post("/addappostile", async(req, res) => {
    ...
    const q = "INSERT INTO apostille(`type`,`tatApost`,`priceEU`,`priceGB`,`priceBU`,`priceCZ`,`pricePL`,`priceDK`,`priceRO`,`priceSE`,`id`,`comment`,`email_text`,`kolejnosc`) VALUES (?)";
...
app.post("/adddelivery", async(req, res) => {
    ...
    const q = "INSERT INTO delivery(`id`,`delivery_option`,`delTat`,`priceEU`,`priceGB`,`priceBU`,`priceCZ`,`pricePL`,`priceDK`,`priceRO`,`priceSE`,`type`,`email_text`,`kolejnosc`) VALUES (?)";
...
app.post("/addcertificate", async(req, res) => {
    ...
    const q = "INSERT INTO certificate(`language`,`tatCER`,`priceEU`,`priceGB`,`priceBU`,`priceCZ`,`pricePL`,`priceDK`,`priceRO`,`priceSE`,`id`,`comment`,`influCer`,`email_text`,`kolejnosc`) VALUES (?)";
...
app.put("/citizenships/:id", async (req, res) => {
    ...
    const q = "UPDATE citizenships SET  `citizenship`= ?, `TAT`= ?, `commentCit`= ?, `email_text`= ?, `pdf_text`= ?, `GTC`= ?, `addtat`=?, `subtat`=?, `ID`= ?, `influCit`=?, `VAT`=?,`kolejnosc`=? WHERE ID = ?";
...
app.put("/apostille/:id", async(req, res) => {
    ...
    const bookId = req.params.id;
    const q = "UPDATE apostille SET `type`= ?, `tatApost`= ?, `priceEU`= ?, `priceGB`= ?, `priceBU`= ?, `priceCZ`= ?, `pricePL`= ?, `priceDK`= ?, `priceRO`= ?, `priceSE`= ?, `id`=?, `comment`=?, `email_text`=?,`kolejnosc`=? WHERE `id` = ?";
...
app.put("/certificate/:id", async(req, res) => {
    ...
    const bookId = req.params.id;
    const q = "UPDATE certificate SET `language`= ?, `tatCER`= ?, `priceEU`= ?, `priceGB`= ?, `priceBU`= ?, `priceCZ`= ?, `pricePL`= ?, `priceDK`= ?, `priceRO`= ?, `priceSE`= ?, `id`=?, `comment`=?, `influCer`=?, `email_text`=?,`kolejnosc`=? WHERE `id` = ?";
...
app.put("/delivery/:id", async(req, res) => {
    ...
    const bookId = req.params.id;
    const q = "UPDATE delivery SET `id`= ?, `delivery_option`= ?, `delTat`= ?,`priceEU`= ?, `priceGB`= ?, `priceBU`= ?, `priceCZ`= ?, `pricePL`= ?, `priceDK`= ?, `priceRO`= ?, `priceSE`= ?, `type`= ?, `email_text`=?,`kolejnosc`=? WHERE `id` = ?";
